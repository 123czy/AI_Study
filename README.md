...
This repository contains examples of different JavaScript design patterns implementations.
...
- Implementation using IIFE (Immediately Invoked Function Expression)
- Demonstrates different pricing strategies

## Features

- Price calculation with different multipliers
- Support for custom price processors
- Error handling for unknown price types
...
console.log(calculator.getPrice('pre', 100)) // 110
console.log(calculator.getPrice('post', 100)) // 120
console.log(calculator.getPrice('tax', 100)) // 130
console.log(calculator.getPrice('sale', 100)) // 140

// Add custom processor
calculator.addProcessor('vip', (price) => (price * 90) / 100)
```
